...
// Show the first 14 days in the picker to keep it scannable.
const pickerDays = calendar.slice(0, 14)
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden rounded-xl bg-card ring-1 ring-border/60">
        ...
        <div className="flex gap-1.5 overflow-x-auto pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {pickerDays.map((d) => (
            <button
              ...
              className={`flex h-9 w-9 shrink-0 cursor-pointer flex-col items-center justify-center rounded-lg border text-[11px] font-semibold leading-none transition-colors ${
                d.day === day
      ...
      <div className="flex flex-1 flex-col gap-3 overflow-y-auto p-4">
        ...
        <div className="mt-auto rounded-lg border border-dashed border-border bg-muted/40 px-3 py-2">
