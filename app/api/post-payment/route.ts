    ...
    const html = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #18181b;">
        ...
        <p style="font-size: 14px; color: #52525b; margin: 0 0 20px; line-height: 1.6;">
          Your payment was successful and your account is ready. Click the button below to log in to your dashboard and start using your Social Media Kit.
        </p>

        ${
          magicLink
            ? `<div style="margin: 0 0 24px;">
                 <a href="${magicLink}" style="display: inline-block; background: #18181b; color: #fff; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; text-decoration: none;">Access your dashboard</a>
                 <p style="font-size: 11px; color: #a1a1aa; margin-top: 12px;">This sign-in link is valid for one hour and can only be used once. After signing in, you'll be asked to set a password for future logins.</p>
               </div>`
            : ""
        }
