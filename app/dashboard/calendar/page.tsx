            ...
            return (
              <li key={day.day}>
                <button
                  ...
                  className={cn(
                    "flex w-full cursor-pointer items-center gap-3 rounded-xl border bg-card px-3 py-3 text-left transition-colors sm:px-4",
                    isOpen ? "border-primary/40" : "border-border hover:border-border",
                  )}
                >
                ...
                {isOpen && (
                  <div className="mx-1 mt-1 mb-1 rounded-xl border border-border bg-card/60 p-4 sm:mx-3 sm:p-5">
